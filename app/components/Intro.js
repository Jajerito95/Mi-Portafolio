...
export default function Intro({ onComplete }) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => setSaliendo(true), 5200)
    setTimeout(() => onComplete(), 6200)
  }, [])

  return (
    <div className={`fixed inset-0 z-[100] bg-[#05020f] flex items-center justify-center transition-opacity duration-1000 ${saliendo ? "opacity-0" : "opacity-100"}`}>
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 grid grid-cols-3 gap-4">
        ...
        <div className={`col-span-1 border border-purple-700/60 bg-black/60 rounded p-4 font-mono text-xs transition-all duration-700 ${fase >= 1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}`}>
          <div className="text-purple-400 font-bold mb-3 text-sm border-b border-purple-700/40 pb-2">
            ⬡ IDENTIFICACIÓN
          </div>
          <div className="space-y-2 text-purple-300">
            ...
            <div className="flex justify-between">
              <span className="text-purple-500">USUARIO:</span>
              <span>ReyKamiS5</span>
            </div>
            <div className="flex justify-between">
              <span className="text-purple-500">ROL:</span>
              <span>Staff / Dev</span>
            </div>
            <div className="flex justify-between">
              <span className="text-purple-500">ORIGEN:</span>
              <span>España</span>
            </div>
          ...
          <div className="space-y-3 text-purple-300">
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-purple-500">MODERACIÓN</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-purple-500">DESARROLLO</span>
                <span className="text-pink-400">60%</span>
              </div>
              <div className="w-full bg-purple-900/30 rounded-full h-1.5">
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-1.5 rounded-full w-[60%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <div className="w-full bg-purple-900/30 rounded-full h-1.5">
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-1.5 rounded-full w-[95%]"></div>
              </div>
            </div>
